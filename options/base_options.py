...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--which_model_netG', type=str, default='unbounded_stn', help='selects model to use for netG')
        ...
        parser.add_argument('--display_port', type=int, default=8007, help='visdom port of the web display')
